  ...
  return !loading ? (
    <div className="text-[#9a8978] mb-28">
      <h1 className="text-2xl">
        Live <span className="text-[#6b5d52] font-medium">Stores</span>
      </h1>
      ...
      {stores.length ? (
          ...
          {stores.map((store) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-2 flex-wrap">
                <p className="text-[#6b5d52]">Active</p>
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-9 h-5 bg-[#d4c4b3] rounded-full peer peer-checked:bg-[#6b5d52] transition-colors duration-200"></div>
        ...
        <div className="flex items-center justify-center h-80">
          <h1 className="text-3xl text-[#9a8978] font-medium">No stores Available</h1>
        </div>
      )}
    </div>
  ) : (
