...
// Calculate shipping based on total cart value
shippingFee = calculateShippingFee(subtotal);

// Keep original subtotal for emails/response
const originalSubtotal = subtotal;

// Reset for order creation loop
subtotal = 0;
...
for (const [storeId, sellerItems] of ordersByStore.entries()) {
  ...
  // ---------------- SHIPPING ----------------
  // Add shipping only once (first store order)
...
// Restore subtotal for email/response
